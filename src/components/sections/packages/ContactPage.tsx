...
const ContactPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white text-black font-['Poppins',sans-serif]">
      {/* MAIN CONTENT */}
      <main ref={containerRef} className="max-w-[1200px] mx-auto px-6 md:px-16 py-4 md:py-8">
        <h1 className="contact-title opacity-0 will-change-transform text-[32px] md:text-[40px] font-bold text-center mb-10 md:mb-16 text-[#0D2464]">Hubungi Kami</h1>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12 items-center">
          {/* Left: Contact Pills */}
          <div className="flex flex-col gap-6 md:gap-8">
            {/* Instagram */}
            <div className="contact-pill opacity-0 will-change-transform flex items-center gap-4 md:gap-6 bg-[#C4D0F8] rounded-full p-3 md:p-4 pl-5 md:pl-6 shadow-lg w-full max-w-[450px] mx-auto md:mx-0">
          ...
          <div className="relative mt-8 md:mt-0">
            <div 
              className="contact-img opacity-0 will-change-transform group relative rounded-[40px] md:rounded-[60px] overflow-hidden shadow-2xl border-4 border-white cursor-pointer"
