...
import { imgRectangle4237 } from "@/components/icons/svg-itpwb";
...
function Group7() {
  return (
    <div className="-translate-x-1/2 absolute contents font-['Poppins:Bold',sans-serif] leading-[20px] left-[calc(54.17%-40.5px)] not-italic text-white top-[918px]">
      ...
      <p className="absolute h-[31px] left-[calc(54.17%-256px)] text-[64px] top-[1018px] w-[431px]">Rp 1.400.000</p>
    </div>
  );
}
...
function Group8() {
  return (
    <div className="-translate-x-1/2 absolute contents font-['Poppins:Bold',sans-serif] leading-[20px] left-[calc(50%+0.5px)] not-italic text-white top-[393px]">
      ...
      <p className="absolute h-[31px] left-[calc(50%-190px)] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-569px_-348px] mask-size-[1518px_559px] text-[64px] top-[493px] w-[380px]" style={{ maskImage: `url('${imgRectangle4237}')` }}>
        Rp 900.000
      </p>
    </div>
  );
...
export default function GatheringTrip() {
  return (
    <div className="bg-white relative size-full" data-name="Gathering Trip">
