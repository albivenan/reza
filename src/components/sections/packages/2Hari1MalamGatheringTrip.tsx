      ...
      <section className="grid grid-cols-2 min-h-screen">
        ...
        <div className="relative">
          ...
          <div className="absolute top-8 left-8 text-white">
            ...
            <h1 className="text-5xl font-bold">Gathering Trip</h1>
          </div>
        </div>

        {/* RIGHT CONTENT */}
        <div className="flex flex-col justify-between space-y-6">
          <div className="flex h-full px-8 flex-col justify-center gap-y-3">
            <p className="font-bold text-[#0d2464] text-xl leading-relaxed">
