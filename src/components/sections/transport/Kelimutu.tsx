  ...
  return (
    <div className="relative bg-white w-full min-h-screen overflow-x-hidden pt-[80px]">
      ...
      <div className="section-hero relative min-h-screen md:h-[800px] grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-8">
        ...
        <InteractiveImage src={imgHero} alt="KM Kelimutu Hero" className="h-[400px] md:h-full rounded-b-2xl md:rounded-b-none">
          ...
          <div className="absolute left-6 md:left-8 top-6 md:top-8 text-white z-20 pointer-events-none">
            <p className="text-[24px] md:text-[36px] font-bold leading-none">KM.</p>
            <h1 className="text-[48px] md:text-[64px] font-bold leading-none">KELIMUTU</h1>
          </div>
        </InteractiveImage>
      ...
      <div className="mt-4 md:mt-6 px-6 md:px-[80px]">
        <a href="/paket/add-ons-glamping-ground" className="section-addon relative block group overflow-hidden">
          <div className="relative h-[300px] md:h-[80vh] rounded-[20px] overflow-hidden shadow-xl">
            <img src={imgAddOn} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" alt="Luxury Suite Upgrade" />
      ...
      <div className="section-info relative mt-20 md:mt-32 px-6 md:px-[80px] pb-24">
        <div className="mb-6 md:mb-8 text-center md:text-left">
          <p className="text-[#0d2464] text-[32px] md:text-[48px] font-bold leading-tight">KM.</p>
          <p className="text-[#0d2464] text-[60px] md:text-[96px] font-bold leading-tight">KELIMUTU</p>
        </div>

        {/* Responsive Container untuk Gambar & Info */}
        <div className="relative grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Gambar kiri */}
          <InteractiveImage src={imgHero} alt="KM Kelimutu Side View" className="md:row-span-2 rounded-[20px] shadow-lg h-[250px] md:h-[400px]" />

          {/* Gambar kanan */}
          <InteractiveImage src={imgKapal2} alt="KM Kelimutu Deck" className="md:col-span-2 rounded-[20px] shadow-lg h-[200px] md:h-[250px]" />
