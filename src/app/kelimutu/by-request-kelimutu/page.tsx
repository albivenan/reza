...
export default function ByRequestKelimutu() {
        ...
        <div className="flex flex-col justify-between space-y-6">
          <div className="flex h-full px-6 md:px-8 py-10 md:py-0 flex-col justify-center gap-y-4 md:gap-y-6">
            <p className="font-bold text-[#0d2464] text-[16px] md:text-xl leading-relaxed text-left">
              Mau liburan ke Karimunjawa dengan KM Kelimutu sesuai gaya kamu? Losala Travel menghadirkan paket open trip by request, dimana kamu bisa menyesuaikan jadwal, destinasi, hingga aktivitas sesuai kebutuhan tetap hemat, tanpa ribet, and pastinya tetap seru!
            </p>
