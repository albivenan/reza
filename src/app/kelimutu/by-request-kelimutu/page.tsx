        ...
        <div className="flex flex-col justify-between space-y-6">
          <div className="flex h-full px-8 flex-col justify-center gap-y-6">
            <p className="font-bold text-[#0d2464] text-xl leading-relaxed text-left">
              Mau liburan ke Karimunjawa dengan KM Kelimutu sesuai gaya kamu? Losala Travel menghadirkan paket open trip by request, dimana kamu bisa menyesuaikan jadwal, destinasi, hingga aktivitas sesuai kebutuhan tetap hemat, tanpa ribet, dan pastinya tetap seru!
            </p>
