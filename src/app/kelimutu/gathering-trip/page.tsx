...
const packages: (PackageItem & { price?: string; href: string })[] = [
  {
    ...
    price: "Rp 1.200.000",
    href: "/kelimutu/gathering-trip/2-hari-1-malam",
    image: img62,
    overlay: true,
  ...
  },
  {
    ...
    price: "Rp 1.650.000",
    href: "/kelimutu/gathering-trip/3-hari-2-malam",
  ...
  },
  {
    ...
    price: "Rp 1.950.000",
    href: "/kelimutu/gathering-trip/4-hari-3-malam",
...
/* ================= PAGE ================= */
export default function KelimutuGatheringTripPage() {
  return (
