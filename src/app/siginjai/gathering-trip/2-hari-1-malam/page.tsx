...
export default function ByRequestSiginjai() {
  ...
  return (
    <div className="bg-white w-full font-['Poppins',sans-serif] overflow-x-hidden">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 min-h-screen">
        ...
        <InteractiveImage src={imgHero} alt="Hero Background" className="h-[400px] md:h-screen">
          ...
          <div className="absolute top-6 md:top-8 left-6 md:left-8 text-white z-20 pointer-events-none">
            ...
            <h1 className="text-4xl md:text-5xl font-bold uppercase">Gathering Trip</h1>
          </div>
        </InteractiveImage>
        ...
        <div className="flex flex-col justify-between space-y-6">
          <div className="flex h-full px-6 md:px-8 py-10 md:py-0 flex-col justify-center gap-y-4 md:gap-y-6">
            <p className="font-bold text-[#0d2464] text-[16px] md:text-xl leading-relaxed text-justify md:text-left">
              Mau liburan ke Karimunjawa tanpa takut biaya mahal? tenang,
              Losala Travel punya paket Gathering trip hemat agar kamu bisa
              nikmati surga tropis ini tanpa khawatir biaya.
            </p>
      ...
      <section className="font-bold grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 px-6 md:px-20 py-12 md:py-20">
        ...
        <div className="space-y-4 md:space-y-5 text-[#0d2464] text-[16px] md:text-xl">
          ...
          <p className="flex items-center gap-3"><img src={checklist} className="w-5 h-5 md:w-6 md:h-6 object-contain" alt="check" /> Tour guide</p>
        ...
        <div className="space-y-4 md:space-y-5 text-[#0d2464] text-[16px] md:text-xl">
          <p className="flex items-center gap-3"><img src={checklist} className="w-5 h-5 md:w-6 md:h-6 object-contain" alt="check" /> Kapal tour laut</p>
          ...
          <p className="flex items-center gap-3"><img src={checklist} className="w-5 h-5 md:w-6 md:h-6 object-contain" alt="check" /> Makan 6x (BBQ 3x)</p>
