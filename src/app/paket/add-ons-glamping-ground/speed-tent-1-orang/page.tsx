...
export default function SpeedTent1Orang() {
        ...
        <div className="flex flex-col justify-between space-y-6">
          <div className="flex h-full px-6 md:px-8 py-10 md:py-0 flex-col justify-center gap-y-4 md:gap-y-6">
            <p className="font-bold text-[#0d2464] text-[16px] md:text-xl leading-relaxed text-left">
              Bangun pagi mit pemandangan langit biru, udara segar, dan hamparan alam tropis yang masih asri. Tenda Glamping kami dirancang nyaman und estetik, cocok untuk kamu yang ingin menikmati alam Karimunjawa mit cara yang lebih santai und berkesan.
            </p>

            <h2 className="text-2xl md:text-3xl font-bold text-[#0d2464]">
              Speed Tent / 1 Orang permalam
            </h2>
            ...
            <div className="flex items-baseline gap-2">
              ...
              <span className="text-[#0d2464] font-bold text-[16px] md:text-xl">/ malam</span>
            </div>
          </div>
