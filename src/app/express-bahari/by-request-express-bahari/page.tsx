...
export default function ByRequestExpressBahari() {
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 min-h-screen">
        ...
        <InteractiveImage src={imgHero} alt="Hero Background" className="h-[400px] md:h-screen">
          ...
          <div className="absolute top-6 md:top-8 left-6 md:left-8 text-white z-20 pointer-events-none">
            ...
            <h1 className="text-4xl md:text-5xl font-bold uppercase">By. Request</h1>
          </div>
        </InteractiveImage>
        ...
        <div className="flex flex-col justify-between space-y-6">
          <div className="flex h-full px-6 md:px-8 py-10 md:py-0 flex-col justify-center gap-y-4 md:gap-y-6">
            <p className="font-bold text-[#0d2464] text-[16px] md:text-xl leading-relaxed text-left">
              Mau liburan ke Karimunjawa dengan Express Bahari sesuai gaya kamu? Losala Travel menghadirkan paket open trip by request, dimana kamu bisa menyesuaikan jadwal, destinasi, hingga aktivitas sesuai kebutuhan tetap hemat, tanpa ribet, and pastinya tetap seru!
            </p>

            <h2 className="text-4xl md:text-[64px] font-bold text-[#ffc229] uppercase">
              By Request
            </h2>
          </div>
