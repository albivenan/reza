    ...
    <div className="bg-white w-full font-['Poppins',sans-serif]">
      ...
      <section className="grid grid-cols-2 min-h-screen">
        ...
        <div className="relative">
          ...
          <div className="absolute top-8 left-8 text-white">
            ...
            <h1 className="text-5xl font-bold uppercase transition-all">By. Request</h1>
          </div>
        </div>
        ...
        <div className="flex flex-col justify-between space-y-6">
          <div className="flex h-full px-8 flex-col justify-center gap-y-6">
            <p className="font-bold text-[#0d2464] text-xl leading-relaxed text-left">
              Mau liburan ke Karimunjawa dengan Express Bahari sesuai gaya kamu? Losala Travel menghadirkan paket open trip by request, dimana kamu bisa menyesuaikan jadwal, destinasi, hingga aktivitas sesuai kebutuhan tetap hemat, tanpa ribet, dan pastinya tetap seru!
            </p>

            <h2 className="text-[64px] font-bold text-[#ffc229] uppercase">
              By Request
            </h2>
          </div>
      ...
      <section className="font-bold grid grid-cols-2 gap-10 px-20 py-20">
        ...
        <div className="space-y-5 text-[#0d2464] text-xl">
          ...
          <p className="flex items-center gap-3"><img src={checklist} className="w-6 h-6 object-contain" /> Tour guide</p>
        ...
        <div className="space-y-5 text-[#0d2464] text-xl">
          <p className="flex items-center gap-3"><img src={checklist} className="w-6 h-6 object-contain" /> Kapal tour laut</p>
          ...
          <p className="flex items-center gap-3"><img src={checklist} className="w-6 h-6 object-contain" /> Makan 6x (BBQ 3x)</p>
