    ...
    <div className="relative bg-white w-full min-h-screen">
      ...
      <div className="section-hero relative h-[800px] grid grid-cols-2 gap-8">
        ...
        <div className="">
          ...
          {[
            { img: img72, title: "Gathering Trip" },
            { img: img29, title: "Private Trip" },
            { img: img13, title: "By. Request" }
          ].map((item, i) => (
            <div key={i} className="relative w-[260px] h-[340px] rounded-[20px] overflow-hidden shadow-xl">
