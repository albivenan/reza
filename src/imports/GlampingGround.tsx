...
function Group6() {
  return (
    <div className="-translate-x-1/2 absolute contents font-['Poppins:Bold',sans-serif] leading-[20px] left-1/2 not-italic text-white top-[903px]">
      <p className="absolute h-[75px] left-[calc(50%-536px)] text-[96px] top-[903px] w-[1072px]">Altreex tent / 1 orang</p>
      <p className="absolute h-[31px] left-[calc(50%-333px)] text-[64px] top-[1033px] w-[665px]">Rp 250.000 / malam</p>
    </div>
  );
}
...
function Group2() {
  return (
    <div className="-translate-x-1/2 absolute contents left-1/2 top-[145px]">
      <div className="-translate-x-1/2 absolute bg-gradient-to-b from-[rgba(217,217,217,0.05)] h-[559px] left-1/2 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-39px_0px] mask-size-[1518px_559px] to-[rgba(13,36,100,0.8)] top-[145px] w-[1440px]" style={{ maskImage: `url('${imgRectangle4237}')` }} />
    </div>
  );
}
...
function Group3() {
  return (
    <div className="-translate-x-1/2 absolute contents left-1/2 top-[1390px]">
      <div className="-translate-x-1/2 absolute bg-gradient-to-b from-[rgba(217,217,217,0.05)] h-[432px] left-1/2 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-39px_-127px] mask-size-[1518px_559px] to-[rgba(13,36,100,0.8)] top-[1390px] w-[1440px]" style={{ maskImage: `url('${imgRectangle4237}')` }} />
      <p className="absolute font-['Poppins:Bold',sans-serif] h-[78px] leading-[20px] left-[calc(50%-294px)] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-465px_-280px] mask-size-[1518px_559px] not-italic text-[96px] text-white top-[1543px] w-[589px]" style={{ maskImage: `url('${imgRectangle4237}')` }}>
        By. Request
      </p>
    </div>
  );
...
function MaskGroup2() {
  return (
    <div className="-translate-x-1/2 absolute contents left-1/2 top-[1263px]" data-name="Mask group">
      ...
      <div className="absolute h-[2810px] left-[-102px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[63px_1256px] mask-size-[1518px_559px] top-[7px] w-[1581px]" data-name="IMG_20250822_100026_121 1" style={{ maskImage: `url('${imgRectangle4237}')` }}>
...
function Group() {
  return (
    <div className="absolute contents left-[78px] top-[1907.51px]">
      <div className="absolute left-[78px] size-[127.129px] top-[1907.51px]" data-name="losala travel logo only">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgLosalaTravelLogoOnly} />
      </div>
      <div className="absolute left-[83.96px] size-[115.207px] top-[1994.36px]" data-name="losala travel logo typography">
...
function Group4() {
  return (
    <div className="absolute contents left-[-213px] top-[1880px]">
      <div className="absolute h-[389px] left-[-213px] top-[1880px] w-[2056px]" data-name="pattern 2-01 6">
        <div className="absolute inset-0 opacity-20 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[373.78%] left-[-0.01%] max-w-none top-[-137.02%] w-[100.02%]" src={imgPattern2016} />
        </div>
      </div>
      <div className="-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-['Roboto:Regular',sans-serif] font-normal h-[100px] justify-center leading-[0] left-[calc(66.67%+226.4px)] text-[20px] text-black text-center top-[2040px] w-[370px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[28px]">© 2024 Travel Explore. All rights reserved.</p>
      </div>
      <div className="-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-['Roboto:Regular',sans-serif] font-normal h-[100px] justify-center leading-[0] left-[calc(83.33%+109.4px)] text-[20px] text-black text-center top-[1947px] w-[124px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[28px]">Privacy Policy</p>
      </div>
      <div className="-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-['Roboto:Regular',sans-serif] font-normal h-[100px] justify-center leading-[0] left-[calc(83.33%+96.4px)] text-[20px] text-black text-center top-[1997px] w-[150px]" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function Group7() {
  return (
    <div className="-translate-x-1/2 absolute contents font-['Poppins:Bold',sans-serif] leading-[20px] left-[calc(54.17%-28px)] not-italic text-white top-[345px]">
      <p className="absolute h-[75px] left-[calc(54.17%-564px)] text-[96px] top-[345px] w-[1072px]">Speed tent / 1 orang</p>
      <p className="absolute h-[31px] left-[calc(54.17%-361px)] text-[64px] top-[475px] w-[665px]">Rp 175.000 / malam</p>
    </div>
  );
}
...
export default function GlampingGround() {
  return (
    <div className="bg-white relative size-full" data-name="Glamping Ground">
